...
def main() -> int:
    ...
    content_lines.append("> Note: the inventory is a static workspace scan. Historical literal subjects from tests (including `cg.v1r3.*`) may appear here as fixtures; they are not the active release protocol for `V1R4`.")
    content_lines.append("")
